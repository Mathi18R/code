...
class Args():
    def __init__(self):
        ...
        print("[WARNING] always check max_num_node and max_prev_node with the used dataset")
        self.max_num_node = 361 # max number of nodes in a graph
        self.max_prev_node = 40 # max previous node that looks back
        ...
        self.hidden_size_rnn_output = int(16)  # hidden size for output RNN
        self.embedding_size_rnn = int(64/self.parameter_shrink) # the size for LSTM input
        self.embedding_size_rnn_output = int(8)  # the embedding size for output rnn
