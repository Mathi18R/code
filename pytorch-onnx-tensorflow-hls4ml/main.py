...
def my_pytorch_to_hls4ml():
    ...
    rename_attribute(rnn, 'input', 'my_input_layer')
    rename_attribute(rnn, 'rnn', 'rnn')
    rename_attribute(rnn, 'output', 'my_output_layer')
    rename_attribute(rnn, 'relu', 'relu')
