...
class Args():
    def __init__(self):
        ...
        self.max_num_node = 39 # max number of nodes in a graph
        self.max_prev_node = 39 # max previous node that looks back
        ...
        self.epochs = 9000 # now one epoch means self.batch_ratio x batch_size
        self.epochs_test_start = 300
        self.epochs_test = 300
        self.epochs_log = 300
        self.epochs_save = 300
